...
// application id.
func GetDevicesForApplicationID(db sqlx.Queryer, applicationID int64, limit, offset int) ([]DeviceListItem, error) {
...
func GetDeviceCountForApplicationID(db sqlx.Queryer, applicationID int64) (int, error) {
	var count int
